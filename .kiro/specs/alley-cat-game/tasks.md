...
- [ ] 1. Extend data models and constants for food items and rival cat mechanics
  - [ ] 1.1 Add FoodItem data class and extend Dustbin/GameState models
  ...
  - [ ] 1.2 Add food-related constants to GameConstants.kt
  ...
  - [ ] 1.3 Add foodSpawnChance to LevelData and LevelSystem
...
- [ ] 2. Implement food item spawning, physics, and collection logic
  - [ ] 2.1 Implement food item spawning on dustbin landing
  ...
  - [ ] 2.2 Implement food item physics and lifecycle
  ...
  - [ ] 2.3 Implement food item collision detection and scoring
...
- [ ] 3. Implement rival cat escape mechanics
  - [ ] 3.1 Add visual warning indicator for emerging rival cats
  ...
  - [ ] 3.2 Implement escape window and delayed collision activation
  ...
  - [ ] 3.3 Add hazard proximity warning haptic feedback
...
- [ ] 5. Refine tutorial system implementation
  - [ ] 5.1 Implement 3-step interactive tutorial flow
  ...
  - [ ] 5.2 Implement tutorial persistence and skip functionality
...
- [ ] 6. Align existing systems with requirements
  - [ ] 6.1 Fix level progression score thresholds and Level 4 completion
  ...
  - [ ] 6.2 Fix landing sound effect trigger
  ...
  - [ ] 6.3 Ensure pause auto-triggers on app background
  ...
  - [ ] 6.4 Ensure high score persistence handles edge cases
...
- [ ] 8. Set up Kotest property testing infrastructure
  - [ ] 8.1 Add Kotest dependencies and configure test runner
  ...
  - [ ] 8.2 Create custom Kotest generators for game state
...
- [ ] 14. Wire food items into rendering and UI
  - [ ] 14.1 Render food items in GameCanvas
  ...
  - [ ] 14.2 Render rival cat warning indicators in GameCanvas
  ...
  - [ ] 14.3 Render tutorial overlays and highlighted zones
...
- [ ] 15. Final integration and wiring
  - [ ] 15.1 Integrate food item updates into main game loop
  ...
  - [ ] 15.2 Integrate rival cat escape mechanics into game loop
  ...
  - [ ] 15.3 Wire tutorial step advancement into input handlers
